...
void boxCorners(const FxEffect::Pose &p,float width,float height, FxEffect::Pose::vec *result)
{
...
///////////////////////////////////////////////////////
// FxAnimation2
// Supports atlas textures
///////////////////////////////////////////////////////
FxAnimation2::FxAnimation2(FxManager *manager, HTEXTURE tex, float x, float y, float w, float h)
	:Base(manager)
	,fps(1.0f)
	...
	else
	{
		...
		for(float y = 0; y < tiledHeight; y += ySegment)
			...
			{			
				...
				Pose bp=p * Pose( x + cropWidth * xSegment/2, y + cropHeight * ySegment/2,0);
				//parts[1]->render(bp);
