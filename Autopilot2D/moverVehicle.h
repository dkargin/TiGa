...
#include "mover.h"
/////////////////////////////////////////////////////////////
// Описывает работу движителей, схожих по кинематике с автомобилем
// направление объекта меняется с постоянной угловой скоростью,
// направление линейной скорости совпадает с направлением движения
// при разрешении поворота на месте получаем танк
// при запрещении поворота на месте получаем 2д самолёт
/////////////////////////////////////////////////////////////
...
public:	
	...
	public:
		...
		bool staticTurn;		// может ли поворачивается на месте
